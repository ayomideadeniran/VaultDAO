...
use types::{
    ...
    CrossVaultProposal, CrossVaultStatus, DelegatedPermission, DexConfig, Dispute,
    ...
    OptionalVaultOracleConfig, Permission, PermissionGrant, Priority, Proposal, ProposalAmendment,
